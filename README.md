...
Turn an HTML page generated by AI into a local workspace where people can edit it visually, preview its interactions, and save changes back to disk.
...
Generate one self-contained HTML page by default: its HTML, CSS, JavaScript, and required visual assets live in one `.html` file, without a CDN or extra project directory. This makes the page easier to copy, open, edit, and share reliably.
